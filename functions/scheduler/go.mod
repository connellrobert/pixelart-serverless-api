module github.com/connellrobert/pixelart-serverless-api/functions/scheduler
...
replace github.com/connellrobert/pixelart-serverless-api/functions/scheduler/internal v0.0.0 => ./internal
require (
